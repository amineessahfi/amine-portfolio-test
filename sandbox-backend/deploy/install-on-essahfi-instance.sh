...
env_values.setdefault('AWS_DEMO_PUBLIC_ENABLED', 'false')
env_values.setdefault('AWS_DEMO_PUBLIC_SPEC_NAME', 'lowcost-data-platform')
env_values.setdefault('AWS_DEMO_PUBLIC_TTL_MINUTES', '10')
env_values.setdefault('AWS_DEMO_PUBLIC_MAX_ACTIVE', '1')
env_values.setdefault('AWS_DEMO_PUBLIC_MAX_LAUNCHES_PER_HOUR', '2')
env_values.setdefault('AWS_DEMO_REGION_ALLOWLIST', 'eu-west-3')
env_values.setdefault('AWS_DEMO_DEFAULT_TTL_MINUTES', '10')
env_values.setdefault('AWS_DEMO_TTL_MIN_MINUTES', '10')
env_values.setdefault('AWS_DEMO_TTL_MAX_MINUTES', '30')
