...
function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 px-4 pt-4 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 rounded-[1.6rem] border border-white/10 bg-[#050816]/78 px-4 py-3.5 shadow-[0_18px_50px_rgba(2,6,23,0.42)] backdrop-blur-2xl sm:flex-nowrap sm:px-5">
